...
for M = 1:5
    ...
    for S = 2:4
        ...
        for D = 1:7
            ...
            M1 = csvread(strcat('C:/Users/jhord/OneDrive/Documentos/tcc/TCC2/script/dados_rede/data/entropy/', num2str(M), '/', num2str(D), '.csv'), 1, 1);
            ...
            M2 = csvread(strcat('C:/Users/jhord/OneDrive/Documentos/tcc/TCC2/script/dados_rede/data/entropy/', num2str(M), '/', num2str(D + 7), '.csv'), 1, 1);
            if S > 2
              %M3 = csvread(strcat('../dados_rede/data/entropy/', num2str(M), '/', num2str(D + 14), '.csv'), 1, 1);
              M3 = csvread(strcat('C:/Users/jhord/OneDrive/Documentos/tcc/TCC2/script/dados_rede/data/entropy/', num2str(M), '/', num2str(D + 14), '.csv'), 1, 1);
            end
            if (S > 3) && (D ~= 4) && (D ~= 5)
              %M4 = csvread(strcat('../dados_rede/data/entropy/', num2str(M), '/', num2str(D + 21), '.csv'), 1, 1);
              M4 = csvread(strcat('C:/Users/jhord/OneDrive/Documentos/tcc/TCC2/script/dados_rede/data/entropy/', num2str(M), '/', num2str(D + 21), '.csv'), 1, 1);
            end
